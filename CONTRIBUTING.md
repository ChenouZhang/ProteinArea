...
We welcome all contributions to ProteinArea!

Contributions can take many forms, such as:

* sharing bug reports or feature requests through the [Issue Tracker](https://github.com/ChenouZhang/ProteinArea/issues)
...
The second two options both involve making a [pull request](https://github.com/ChenouZhang/ProteinArea/pulls) .
