...
short_description = "A package to calculate time-series protein area profile of MD data.".strip().split("\n")[0]
...
setup(
    ...
    # url='ProteinArea.readthedocs.io/en/latest/',  # Website
    # platforms=['Linux',
    #            'Mac OS-X',
    #            'Unix',
